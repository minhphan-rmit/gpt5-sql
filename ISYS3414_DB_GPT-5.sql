...
-- Salary Adjustment table population (Only for RMIT-U-0022)
INSERT INTO SALARY_ADJUSTMENT (ADJUSTMENTID, EMPLOYEEID, ADJUSTMENTDATE, ADJUSTMENTAMOUNT, ADJUSTMENTTYPE, REASON)
VALUES ('RMIT-A-0001', 'RMIT-E-0022', TO_DATE('2022-02-28', 'YYYY-MM-DD'), 160, 'Deduction', 'Tax Deduction');

INSERT INTO SALARY_ADJUSTMENT (ADJUSTMENTID, EMPLOYEEID, ADJUSTMENTDATE, ADJUSTMENTAMOUNT, ADJUSTMENTTYPE, REASON)
VALUES ('RMIT-A-0002', 'RMIT-E-0022', TO_DATE('2022-03-31', 'YYYY-MM-DD'), 175, 'Deduction', 'Tax Deduction');

INSERT INTO SALARY_ADJUSTMENT (ADJUSTMENTID, EMPLOYEEID, ADJUSTMENTDATE, ADJUSTMENTAMOUNT, ADJUSTMENTTYPE, REASON)
VALUES ('RMIT-A-0003', 'RMIT-E-0022', TO_DATE('2022-04-30', 'YYYY-MM-DD'), 190, 'Deduction', 'Tax Deduction');

INSERT INTO SALARY_ADJUSTMENT (ADJUSTMENTID, EMPLOYEEID, ADJUSTMENTDATE, ADJUSTMENTAMOUNT, ADJUSTMENTTYPE, REASON)
VALUES ('RMIT-A-0004', 'RMIT-E-0022', TO_DATE('2022-05-31', 'YYYY-MM-DD'), 200, 'Deduction', 'Tax Deduction');

INSERT INTO SALARY_ADJUSTMENT (ADJUSTMENTID, EMPLOYEEID, ADJUSTMENTDATE, ADJUSTMENTAMOUNT, ADJUSTMENTTYPE, REASON)
VALUES ('RMIT-A-0005', 'RMIT-E-0022', TO_DATE('2022-06-30', 'YYYY-MM-DD'), 210, 'Deduction', 'Tax Deduction');


-- Salary Summary table population (Only for RMIT-U-0022)
-- Record 1
...
VALUES ('RMIT-SS-0001', 'RMIT-E-0022', TO_DATE('2022-01-31', 'YYYY-MM-DD'), 3000, 2850, 2850, 3000, 150);

-- Record 2
INSERT INTO SALARY_SUMMARY (SALARYSUMMARYID, EMPLOYEEID, PAYMENTDATE, BASESALARY, NETSALARY, TOTALSAVINGS, CTCSALARY, TAXDEDUCTION)
VALUES ('RMIT-SS-0002', 'RMIT-E-0022', TO_DATE('2022-02-28', 'YYYY-MM-DD'), 3200, 3040, 5890, 3200, 160);

-- Record 3
INSERT INTO SALARY_SUMMARY (SALARYSUMMARYID, EMPLOYEEID, PAYMENTDATE, BASESALARY, NETSALARY, TOTALSAVINGS, CTCSALARY, TAXDEDUCTION)
VALUES ('RMIT-SS-0003', 'RMIT-E-0022', TO_DATE('2022-03-31', 'YYYY-MM-DD'), 3500, 3325, 9215, 3500, 175);

-- Record 4
INSERT INTO SALARY_SUMMARY (SALARYSUMMARYID, EMPLOYEEID, PAYMENTDATE, BASESALARY, NETSALARY, TOTALSAVINGS, CTCSALARY, TAXDEDUCTION)
VALUES ('RMIT-SS-0004', 'RMIT-E-0022', TO_DATE('2022-04-30', 'YYYY-MM-DD'), 3800, 3610, 12825, 3800, 190);

-- Record 5
INSERT INTO SALARY_SUMMARY (SALARYSUMMARYID, EMPLOYEEID, PAYMENTDATE, BASESALARY, NETSALARY, TOTALSAVINGS, CTCSALARY, TAXDEDUCTION)
VALUES ('RMIT-SS-0005', 'RMIT-E-0022', TO_DATE('2022-05-31', 'YYYY-MM-DD'), 4000, 3800, 16625, 4000, 200);

-- Record 6
INSERT INTO SALARY_SUMMARY (SALARYSUMMARYID, EMPLOYEEID, PAYMENTDATE, BASESALARY, NETSALARY, TOTALSAVINGS, CTCSALARY, TAXDEDUCTION)
VALUES ('RMIT-SS-0006', 'RMIT-E-0022', TO_DATE('2022-06-30', 'YYYY-MM-DD'), 4200, 3990, 20615, 4200, 210);
